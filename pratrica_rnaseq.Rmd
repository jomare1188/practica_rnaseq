...
Muitas das análises exploratórias requerem dados homocedastic, que nossas contagens não são. No DESeq2 a função vst e rlog, pode normalizar os dados para torná-lo mais hocedasticos . Como regra vst é melhor quando você tem mais de 30 amostras
